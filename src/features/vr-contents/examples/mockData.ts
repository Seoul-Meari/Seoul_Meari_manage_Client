...
export const MOCK_BUNDLES: AssetBundle[] = [
  {
    ...
    bundleUrl:
      "https://cdn.example.com/bundles/historical/seoul/gyeongbokgung_main_hall_v1.0.1.bundle",
    name: "경복궁_근정전",
    version: "1.0.1",
    status: "published",
    usage: "historical",
  ...
  },
  {
    ...
    bundleUrl:
      "https://cdn.example.com/bundles/promo/gangnam_promo_2025_v2.0.0.bundle",
    name: "브랜드_포토월_2025",
    version: "2.0.0",
    status: "draft",
    usage: "promo",
    ...
    prefabs: [
      {
        id: "p-006",
        name: "Photowall_Frame",
        sizeMB: 30.1,
        tags: ["frame", "event"],
      },
      {
        id: "p-007",
        name: "Logo_3D_Spinning",
        sizeMB: 14.0,
        tags: ["logo", "animation"],
      },
    ],
